...
To get an instance of the self-hosted Realm Object Server, you'll need to [sign up for a trial here](https://realm.io/trial/self-hosted-standard-plan).  You'll receive an email with your trial token and some installation instructions.  You can also [find those instructions here](https://docs.realm.io/platform/self-hosting/installation).    
{% endtab %}
{% endtabs %}
...
![](.gitbook/assets/cloud-studio.png)
...
![Example Cloud URL](.gitbook/assets/screen-shot-2018-06-21-at-11.23.48-am.png)
{% endtab %}

{% tab title="Self-hosting" %}
Connecting to your self-hosted instance is easy with Realm Studio.  Just click the "Connect to Server" button.  

![Realm Studio Landing](.gitbook/assets/cloud-studio%20%281%29.png)
...
![](.gitbook/assets/screen-shot-2018-06-22-at-5.07.26-pm.png)
...
Next we'll authenticate against our instance of the Realm Object Server and open up the default realm. We'll also add a basic error handler to catch errors in case of a failure.  You can find [more details on authentication here](https://docs.realm.io/platform/using-synced-realms/user-authentication) \(in case you'd like to use an alternate provider\).  You can find some of the [specifics of opening a realm here](https://docs.realm.io/platform/using-synced-realms/opening-a-synced-realm).  
...
* [iOS: Swift Example App ](https://docs.realm.io/platform/getting-started-1/ios-quick-start)
* [Android: Java Example App](https://docs.realm.io/platform/getting-started-1/android-quick-start)
...
{% hint style="info" %}
If you are working with the self-hosted version of Realm Platform, you will need to enable the GraphQL API on your Realm Object Server.  [More details here](https://docs.realm.io/platform/self-hosting/customize/web-integration#setup-graphql-service).  
{% endhint %}

### Prerequisites

You'll need to have everything that was [required for the previous server SDK example](walkthrough.md#prerequisites).
...
You can [learn more about the various queries and mutations that you can make with GraphQL here](https://docs.realm.io/platform/graphql-web-access/how-to-use-the-api).  
