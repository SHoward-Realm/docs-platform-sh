...
var FEATURE_TOKEN = "INSERT_FEATURE_TOKEN";
...
The following example was made to be easily used with our [ToDo app tutorial](../getting-started/create-my-first-app.md).  It takes advantage of the [wit.ai](https://wit.ai/) API which can be used for basic text recognition.  
...
var token = "INSERT_YOUR_FEATURE_TOKEN";
